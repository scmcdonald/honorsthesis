...
summary(top4_grad_bishop)
    ...
    top4_table[top4_table$Variable  == "Graduate Enrollment Publicity Coefficient","Bishop Accountability: Linear"] <- summary(top4_graduate_bishop)$coefficients[2, 1]
  
    top4_table[top4_table$Variable  == "Graduate Enrollment P-Value","Bishop Accountability: Linear"] <- summary(top4_graduate_bishop)$coefficients[2, 4]
  
    top4_table[top4_table$Variable  == "Graduate Enrollment R-squared","Bishop Accountability: Linear"] <-summary(top4_graduate_bishop)$r.squared
...
summary(top4_undergrad_bishop_sqrt)
    ...
    top4_table[top4_table$Variable  == "Underundergraduateuate Enrollment Publicity Coefficient","Bishop Accountability: Square Root"] <- summary(top4_undergraduate_bishop_sqrt)$coefficients[2, 1]
  
    top4_table[top4_table$Variable  == "Underundergraduateuate Enrollment P-Value","Bishop Accountability: Square Root"] <- summary(top4_undergraduate_bishop_sqrt)$coefficients[2, 4]
  
    top4_table[top4_table$Variable  == "Underundergraduateuate Enrollment R-squared","Bishop Accountability: Square Root"] <-summary(top4_undergraduate_bishop_sqrt)$r.squared
